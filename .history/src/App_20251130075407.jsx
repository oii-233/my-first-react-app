    ...
    <main>
      <div className=' pattern'/>
       <div className='wrapper'>
        <header
          className='relative w-full h-[350px] flex flex-col justify-center items-center text-center'
          style={{background: "url('./hero.png')", backgroundSize: "cover", backgroundPosition: "center" }}
        >
